...
public class BluetoothModule {
    ...
    private final MpiEventHandler<ConnectionInfo> mConnectEventHandler =
            new MpiEventHandler<ConnectionInfo>() {
                ...
                public void handle(@NonNull ConnectionInfo arg) {
                    ...
                    Log.d(TAG, "mConnectEventHandler");
    ...
    private final MpiEventHandler<ConnectionInfo> mDisconnectEventHandler =
            new MpiEventHandler<ConnectionInfo>() {
                ...
                public void handle(@NonNull ConnectionInfo arg) {
                    ...
                    Log.d(TAG,  "mDisconnectEventHandler");
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            Log.d(TAG, String.format("handleMessage: msg.what:%s", msg.what));
...
//            connector = new ClientSocketConnector(addr, 6543);
            ...
            try {
                ...
                if (!BluetoothModule.this.mSessionOpened.compareAndSet(false, true)) {
                    Log.e(TAG, "Failed to set mSessionOpened??");
                }
                ...
                if (BluetoothModule.this.mSessionOpened.get()) {
                    Log.e(TAG,  "Failed to openSession but mSessionOpened is set??");
                }
            }
    ...
    public void closeSession() {
        try {
            ...
            Log.d(TAG, "closeSession: " + e.getMessage());
        }
    }
    ...
    /**
     * Sets default device in categor {@link com.miurasystems.mpi.api.executor.MiuraManager.DeviceType}
     *
     * @param context         Application Context
    ...
    /**
     * Check if selected device is default in category {@link com.miurasystems.mpi.api.executor.MiuraManager.DeviceType}
     *
     * @param context         Application Context
     * @param bluetoothDevice Selected BluetoothDevice
     * @return result
    ...
    /**
     * @param context    Application Context
     * @param deviceType {@link com.miurasystems.mpi.api.executor.MiuraManager.DeviceType}
     * @return Default device in selected category {@link com.miurasystems.mpi.api.executor.MiuraManager.DeviceType}
     */
    @UiThread
