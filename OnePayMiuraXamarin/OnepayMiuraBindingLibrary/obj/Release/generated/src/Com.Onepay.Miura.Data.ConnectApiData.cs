...
namespace Com.Onepay.Miura.Data {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConnectApiData']"
	[global::Android.Runtime.Register ("com/onepay/miura/data/ConnectApiData", DoNotGenerateAcw=true)]
	public partial class ConnectApiData : global::Java.Lang.Object {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onepay/miura/data/ConnectApiData", typeof (ConnectApiData));
		...
		protected ConnectApiData (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConnectApiData']/constructor[@name='ConnectApiData' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ConnectApiData ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onepay.Miura.Data.ConnectApiData> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewString (__this.ReturnReason ());
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConnectApiData']/method[@name='returnReason' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConnectApiData']/method[@name='returnStatus' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConnectApiData']/method[@name='setReturnReason' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConnectApiData']/method[@name='setReturnStatus' and count(parameter)=1 and parameter[1][@type='int']]"
