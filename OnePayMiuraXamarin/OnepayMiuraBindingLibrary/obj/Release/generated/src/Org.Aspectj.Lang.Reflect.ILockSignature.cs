...
namespace Org.Aspectj.Lang.Reflect {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='LockSignature']"
	[Register ("org/aspectj/lang/reflect/LockSignature", "", "Org.Aspectj.Lang.Reflect.ILockSignatureInvoker")]
	public partial interface ILockSignature : global::Org.Aspectj.Lang.ISignature {

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/LockSignature", DoNotGenerateAcw=true)]
	internal partial class ILockSignatureInvoker : global::Java.Lang.Object, ILockSignature {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/reflect/LockSignature", typeof (ILockSignatureInvoker));
		...
		public static ILockSignature GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ILockSignature> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.reflect.LockSignature"));
			return handle;
		}
		...
		public ILockSignatureInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.ILockSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
