...
namespace Com.Onepay.Miura.Data {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConfigApiData']"
	[global::Android.Runtime.Register ("com/onepay/miura/data/ConfigApiData", DoNotGenerateAcw=true)]
	public partial class ConfigApiData : global::Java.Lang.Object {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onepay/miura/data/ConfigApiData", typeof (ConfigApiData));
		...
		protected ConfigApiData (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConfigApiData']/constructor[@name='ConfigApiData' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ConfigApiData ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onepay.Miura.Data.ConfigApiData> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewString (__this.ReturnReason ());
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConfigApiData']/method[@name='returnReason' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConfigApiData']/method[@name='returnStatus' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConfigApiData']/method[@name='setReturnReason' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onepay.miura.data']/class[@name='ConfigApiData']/method[@name='setReturnStatus' and count(parameter)=1 and parameter[1][@type='int']]"
