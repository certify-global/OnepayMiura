...
namespace Org.Aspectj.Lang.Annotation {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang.annotation']/interface[@name='Pointcut']"
	[Register ("org/aspectj/lang/annotation/Pointcut", "", "Org.Aspectj.Lang.Annotation.IPointcutInvoker")]
	public partial interface IPointcut : global::Java.Lang.Annotation.IAnnotation {

		// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.annotation']/interface[@name='Pointcut']/method[@name='argNames' and count(parameter)=0]"
		[Register ("argNames", "()Ljava/lang/String;", "GetArgNamesHandler:Org.Aspectj.Lang.Annotation.IPointcutInvoker, OnepayMiuraBindingLibrary")]
		string ArgNames ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.annotation']/interface[@name='Pointcut']/method[@name='value' and count(parameter)=0]"
		[Register ("value", "()Ljava/lang/String;", "GetValueHandler:Org.Aspectj.Lang.Annotation.IPointcutInvoker, OnepayMiuraBindingLibrary")]
		string Value ();

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/annotation/Pointcut", DoNotGenerateAcw=true)]
	internal partial class IPointcutInvoker : global::Java.Lang.Object, IPointcut {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/annotation/Pointcut", typeof (IPointcutInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.annotation.Pointcut"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Annotation.IPointcut> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
