...
namespace Org.Aspectj.Internal.Lang.Annotation {
	...
	public partial interface IAjcITD : global::Java.Lang.Annotation.IAnnotation {
		...
		[Register ("modifiers", "()I", "GetModifiersHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcITDInvoker, OnepayMiuraBindingLibrary")]
		int Modifiers ();
		...
		[Register ("name", "()Ljava/lang/String;", "GetNameHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcITDInvoker, OnepayMiuraBindingLibrary")]
		string Name ();
		...
		[Register ("targetType", "()Ljava/lang/String;", "GetTargetTypeHandler:Org.Aspectj.Internal.Lang.Annotation.IAjcITDInvoker, OnepayMiuraBindingLibrary")]
		string TargetType ();

	}

	[global::Android.Runtime.Register ("org/aspectj/internal/lang/annotation/ajcITD", DoNotGenerateAcw=true)]
	internal partial class IAjcITDInvoker : global::Java.Lang.Object, IAjcITD {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/internal/lang/annotation/ajcITD", typeof (IAjcITDInvoker));
...
#pragma warning disable 0169
		static Delegate GetModifiersHandler ()
		{
			if (cb_modifiers == null)
				cb_modifiers = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_I) n_Modifiers);
			return cb_modifiers;
		}

		static int n_Modifiers (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Internal.Lang.Annotation.IAjcITD> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning disable 0169
		static Delegate GetTargetTypeHandler ()
		{
			if (cb_targetType == null)
				cb_targetType = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_TargetType);
