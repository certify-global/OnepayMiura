...
namespace Org.Aspectj.Lang.Reflect {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='CatchClauseSignature']"
	[Register ("org/aspectj/lang/reflect/CatchClauseSignature", "", "Org.Aspectj.Lang.Reflect.ICatchClauseSignatureInvoker")]
	public partial interface ICatchClauseSignature : global::Org.Aspectj.Lang.ISignature {

		string ParameterName {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='CatchClauseSignature']/method[@name='getParameterName' and count(parameter)=0]"
			[Register ("getParameterName", "()Ljava/lang/String;", "GetGetParameterNameHandler:Org.Aspectj.Lang.Reflect.ICatchClauseSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

		global::Java.Lang.Class ParameterType {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='CatchClauseSignature']/method[@name='getParameterType' and count(parameter)=0]"
			[Register ("getParameterType", "()Ljava/lang/Class;", "GetGetParameterTypeHandler:Org.Aspectj.Lang.Reflect.ICatchClauseSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/CatchClauseSignature", DoNotGenerateAcw=true)]
	internal partial class ICatchClauseSignatureInvoker : global::Java.Lang.Object, ICatchClauseSignature {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/reflect/CatchClauseSignature", typeof (ICatchClauseSignatureInvoker));
		...
		public static ICatchClauseSignature GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<ICatchClauseSignature> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.reflect.CatchClauseSignature"));
			return handle;
		}
		...
		public ICatchClauseSignatureInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetParameterNameHandler ()
		{
			if (cb_getParameterName == null)
				cb_getParameterName = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetParameterName);
			return cb_getParameterName;
		}

		static IntPtr n_GetParameterName (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.ICatchClauseSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewString (__this.ParameterName);
		}
#pragma warning restore 0169

		IntPtr id_getParameterName;
		public unsafe string ParameterName {
			get {
				...
				return JNIEnv.GetString (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getParameterName), JniHandleOwnership.TransferLocalRef);
			}
		}

		static Delegate cb_getParameterType;
#pragma warning disable 0169
		static Delegate GetGetParameterTypeHandler ()
		{
			if (cb_getParameterType == null)
				cb_getParameterType = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetParameterType);
			return cb_getParameterType;
		}

		static IntPtr n_GetParameterType (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.ICatchClauseSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.ParameterType);
		}
#pragma warning restore 0169

		IntPtr id_getParameterType;
		public unsafe global::Java.Lang.Class ParameterType {
			get {
				if (id_getParameterType == IntPtr.Zero)
					id_getParameterType = JNIEnv.GetMethodID (class_ref, "getParameterType", "()Ljava/lang/Class;");
				return global::Java.Lang.Object.GetObject<global::Java.Lang.Class> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getParameterType), JniHandleOwnership.TransferLocalRef);
			}
		}
