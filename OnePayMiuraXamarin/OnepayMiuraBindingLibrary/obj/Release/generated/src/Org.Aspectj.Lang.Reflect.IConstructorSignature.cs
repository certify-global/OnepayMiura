...
namespace Org.Aspectj.Lang.Reflect {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='ConstructorSignature']"
	[Register ("org/aspectj/lang/reflect/ConstructorSignature", "", "Org.Aspectj.Lang.Reflect.IConstructorSignatureInvoker")]
	public partial interface IConstructorSignature : global::Org.Aspectj.Lang.Reflect.ICodeSignature {

		global::Java.Lang.Reflect.Constructor Constructor {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='ConstructorSignature']/method[@name='getConstructor' and count(parameter)=0]"
			[Register ("getConstructor", "()Ljava/lang/reflect/Constructor;", "GetGetConstructorHandler:Org.Aspectj.Lang.Reflect.IConstructorSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/ConstructorSignature", DoNotGenerateAcw=true)]
	internal partial class IConstructorSignatureInvoker : global::Java.Lang.Object, IConstructorSignature {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/reflect/ConstructorSignature", typeof (IConstructorSignatureInvoker));
		...
		public static IConstructorSignature GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IConstructorSignature> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.reflect.ConstructorSignature"));
			return handle;
		}
		...
		public IConstructorSignatureInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetConstructorHandler ()
		{
			if (cb_getConstructor == null)
				cb_getConstructor = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetConstructor);
			return cb_getConstructor;
		}

		static IntPtr n_GetConstructor (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IConstructorSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Constructor);
		}
#pragma warning restore 0169

		IntPtr id_getConstructor;
		public unsafe global::Java.Lang.Reflect.Constructor Constructor {
			get {
				if (id_getConstructor == IntPtr.Zero)
					id_getConstructor = JNIEnv.GetMethodID (class_ref, "getConstructor", "()Ljava/lang/reflect/Constructor;");
				return global::Java.Lang.Object.GetObject<global::Java.Lang.Reflect.Constructor> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getConstructor), JniHandleOwnership.TransferLocalRef);
			}
		}
