...
namespace Org.Aspectj.Lang.Reflect {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='InitializerSignature']"
	[Register ("org/aspectj/lang/reflect/InitializerSignature", "", "Org.Aspectj.Lang.Reflect.IInitializerSignatureInvoker")]
	public partial interface IInitializerSignature : global::Org.Aspectj.Lang.Reflect.ICodeSignature {

		global::Java.Lang.Reflect.Constructor Initializer {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='InitializerSignature']/method[@name='getInitializer' and count(parameter)=0]"
			[Register ("getInitializer", "()Ljava/lang/reflect/Constructor;", "GetGetInitializerHandler:Org.Aspectj.Lang.Reflect.IInitializerSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/InitializerSignature", DoNotGenerateAcw=true)]
	internal partial class IInitializerSignatureInvoker : global::Java.Lang.Object, IInitializerSignature {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/reflect/InitializerSignature", typeof (IInitializerSignatureInvoker));
		...
		public static IInitializerSignature GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IInitializerSignature> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.reflect.InitializerSignature"));
			return handle;
		}
		...
		public IInitializerSignatureInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
		...
		static Delegate cb_getInitializer;
#pragma warning disable 0169
		static Delegate GetGetInitializerHandler ()
		{
			if (cb_getInitializer == null)
				cb_getInitializer = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetInitializer);
			return cb_getInitializer;
		}

		static IntPtr n_GetInitializer (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IInitializerSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.Initializer);
		}
#pragma warning restore 0169

		IntPtr id_getInitializer;
		public unsafe global::Java.Lang.Reflect.Constructor Initializer {
			get {
				if (id_getInitializer == IntPtr.Zero)
					id_getInitializer = JNIEnv.GetMethodID (class_ref, "getInitializer", "()Ljava/lang/reflect/Constructor;");
				return global::Java.Lang.Object.GetObject<global::Java.Lang.Reflect.Constructor> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getInitializer), JniHandleOwnership.TransferLocalRef);
			}
		}
