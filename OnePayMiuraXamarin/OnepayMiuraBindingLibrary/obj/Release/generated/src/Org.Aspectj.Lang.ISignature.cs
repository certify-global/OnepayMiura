...
namespace Org.Aspectj.Lang {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']"
	[Register ("org/aspectj/lang/Signature", "", "Org.Aspectj.Lang.ISignatureInvoker")]
	public partial interface ISignature : IJavaObject, IJavaPeerable {

		global::Java.Lang.Class DeclaringType {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']/method[@name='getDeclaringType' and count(parameter)=0]"
			[Register ("getDeclaringType", "()Ljava/lang/Class;", "GetGetDeclaringTypeHandler:Org.Aspectj.Lang.ISignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

		string DeclaringTypeName {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']/method[@name='getDeclaringTypeName' and count(parameter)=0]"
			[Register ("getDeclaringTypeName", "()Ljava/lang/String;", "GetGetDeclaringTypeNameHandler:Org.Aspectj.Lang.ISignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

		int Modifiers {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']/method[@name='getModifiers' and count(parameter)=0]"
			[Register ("getModifiers", "()I", "GetGetModifiersHandler:Org.Aspectj.Lang.ISignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

		string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']/method[@name='getName' and count(parameter)=0]"
			[Register ("getName", "()Ljava/lang/String;", "GetGetNameHandler:Org.Aspectj.Lang.ISignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

		// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']/method[@name='toLongString' and count(parameter)=0]"
		[Register ("toLongString", "()Ljava/lang/String;", "GetToLongStringHandler:Org.Aspectj.Lang.ISignatureInvoker, OnepayMiuraBindingLibrary")]
		string ToLongString ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']/method[@name='toShortString' and count(parameter)=0]"
		[Register ("toShortString", "()Ljava/lang/String;", "GetToShortStringHandler:Org.Aspectj.Lang.ISignatureInvoker, OnepayMiuraBindingLibrary")]
		string ToShortString ();

		// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang']/interface[@name='Signature']/method[@name='toString' and count(parameter)=0]"
		[Register ("toString", "()Ljava/lang/String;", "GetToStringHandler:Org.Aspectj.Lang.ISignatureInvoker, OnepayMiuraBindingLibrary")]
		string ToString ();

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/Signature", DoNotGenerateAcw=true)]
	internal partial class ISignatureInvoker : global::Java.Lang.Object, ISignature {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/Signature", typeof (ISignatureInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.Signature"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.ISignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
