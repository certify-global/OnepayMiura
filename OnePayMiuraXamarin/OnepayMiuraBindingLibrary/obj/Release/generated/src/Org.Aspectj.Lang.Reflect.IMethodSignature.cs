...
namespace Org.Aspectj.Lang.Reflect {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='MethodSignature']"
	[Register ("org/aspectj/lang/reflect/MethodSignature", "", "Org.Aspectj.Lang.Reflect.IMethodSignatureInvoker")]
	public partial interface IMethodSignature : global::Org.Aspectj.Lang.Reflect.ICodeSignature {

		global::Java.Lang.Reflect.Method Method {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='MethodSignature']/method[@name='getMethod' and count(parameter)=0]"
			[Register ("getMethod", "()Ljava/lang/reflect/Method;", "GetGetMethodHandler:Org.Aspectj.Lang.Reflect.IMethodSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

		global::Java.Lang.Class ReturnType {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='MethodSignature']/method[@name='getReturnType' and count(parameter)=0]"
			[Register ("getReturnType", "()Ljava/lang/Class;", "GetGetReturnTypeHandler:Org.Aspectj.Lang.Reflect.IMethodSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/MethodSignature", DoNotGenerateAcw=true)]
	internal partial class IMethodSignatureInvoker : global::Java.Lang.Object, IMethodSignature {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/reflect/MethodSignature", typeof (IMethodSignatureInvoker));
		...
		public static IMethodSignature GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IMethodSignature> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.reflect.MethodSignature"));
			return handle;
		}
		...
		public IMethodSignatureInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		static Delegate GetGetMethodHandler ()
		{
			if (cb_getMethod == null)
				cb_getMethod = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_L) n_GetMethod);
			return cb_getMethod;
		}

		static IntPtr n_GetMethod (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IMethodSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
		...
		public unsafe global::Java.Lang.Reflect.Method Method {
			get {
				if (id_getMethod == IntPtr.Zero)
					id_getMethod = JNIEnv.GetMethodID (class_ref, "getMethod", "()Ljava/lang/reflect/Method;");
				return global::Java.Lang.Object.GetObject<global::Java.Lang.Reflect.Method> (JNIEnv.CallObjectMethod (((global::Java.Lang.Object) this).Handle, id_getMethod), JniHandleOwnership.TransferLocalRef);
			}
		}
