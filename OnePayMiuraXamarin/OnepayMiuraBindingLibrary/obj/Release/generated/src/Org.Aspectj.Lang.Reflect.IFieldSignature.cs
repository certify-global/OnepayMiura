...
namespace Org.Aspectj.Lang.Reflect {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='FieldSignature']"
	[Register ("org/aspectj/lang/reflect/FieldSignature", "", "Org.Aspectj.Lang.Reflect.IFieldSignatureInvoker")]
	public partial interface IFieldSignature : global::Org.Aspectj.Lang.Reflect.IMemberSignature {

		global::Java.Lang.Reflect.Field Field {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='FieldSignature']/method[@name='getField' and count(parameter)=0]"
			[Register ("getField", "()Ljava/lang/reflect/Field;", "GetGetFieldHandler:Org.Aspectj.Lang.Reflect.IFieldSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

		global::Java.Lang.Class FieldType {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.aspectj.lang.reflect']/interface[@name='FieldSignature']/method[@name='getFieldType' and count(parameter)=0]"
			[Register ("getFieldType", "()Ljava/lang/Class;", "GetGetFieldTypeHandler:Org.Aspectj.Lang.Reflect.IFieldSignatureInvoker, OnepayMiuraBindingLibrary")] get;
		}

	}

	[global::Android.Runtime.Register ("org/aspectj/lang/reflect/FieldSignature", DoNotGenerateAcw=true)]
	internal partial class IFieldSignatureInvoker : global::Java.Lang.Object, IFieldSignature {

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/aspectj/lang/reflect/FieldSignature", typeof (IFieldSignatureInvoker));
		...
		public static IFieldSignature GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IFieldSignature> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.aspectj.lang.reflect.FieldSignature"));
			return handle;
		}
		...
		public IFieldSignatureInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Aspectj.Lang.Reflect.IFieldSignature> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		IntPtr id_getFieldType;
		public unsafe global::Java.Lang.Class FieldType {
			get {
